  ...
  return (
    <>
      <motion.div
        ...
        className="mx-2 my-4 overflow-hidden transition-all duration-300 bg-white shadow-box-event rounded-xl hover:shadow-box-event-hover hover:-translate-y-[5px]"
      >
        <img
        ...
        <div className="p-6 min-h-[308px]">
          <h6 className="mb-2 text-xl font-bold line-clamp-3 leading-[1.6]">
            {item.title}
          </h6>
