...
function Navbar() {
  ...
  return (
    <>
      {/* Navigation Bar */}
      <div className="sticky top-0 z-10 bg-gradient-to-r from-[#98D7EC] via-[#1D82E0] to-[#98D7EC] shadow-md py-2 px-4 flex items-center justify-between md:justify-center">
        {/* Mobile menu button */}
